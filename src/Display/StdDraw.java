 ...
 *  <ul>
 *  <li> {@link #setBackgroundColor()}
 *  <li> {@link #setBackgroundColor(Color color)}
 *  </ul>
 *  <p>
 ...
 *  </ul>
 *  <p>
 *  The {@link #setBackgroundColor()}, {@link #show()}, and {@link #pause(int t)} methods
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static void init() {
        ...
        frame.setTitle("Computational Geometry Demo William Douglas");
    ...
    public static void setBackgroundColor() {
        setBackgroundColor(DEFAULT_CLEAR_COLOR);
    }
...
*/
    ...
    public static void waitForMouse(){
    ...
    public static void main(String[] args) {
        ...
        for (double t = 0.0; true; t += 0.02) {
            double xi = Math.sin(t);
            double yi = Math.cos(t);
            double xii = Math.sin(t+0.02);
            double yii = Math.cos(t+0.02);

            StdDraw.setPenColor(Color.WHITE);
            StdDraw.filledCircle(xi, yi, 0.055);
            StdDraw.setPenColor(Color.RED);
            StdDraw.filledCircle(xii, yii, 0.05);
